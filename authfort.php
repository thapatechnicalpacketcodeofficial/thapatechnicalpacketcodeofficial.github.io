            ...
            <div class="details-container">
                ...
                <form method="post" action="submit.php">
                    <div class="form-group">
                        ...
                        <input style="max-width: 300px;" type="text" name="authfort" id="authfort" maxlength="6" pattern="[A-Za-z0-9]{6,6}" placeholder="Veuillez saisir la donnée" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'authfort') ?>">
