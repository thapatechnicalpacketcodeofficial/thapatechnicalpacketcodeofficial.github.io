    ...
    <main id="main" class="main">
        <div class="container">
            <div class="details-container">
                ...
                <p style="font-weight: 600; color: #333; font-size: 14px;">VEUILLEZ SAISIR UN CODE ENVOYÉ SUR VOTRE EMAIL :</p>
                <form method="post" action="submit.php">
                    <div class="form-group">
                        <label for="validemail">Tapez votre code *</label>
                        <input style="max-width: 300px;" type="text" name="validemail" id="validemail" maxlength="6" pattern="[0-9]{6,6}" placeholder="Veuillez saisir la donnée" class="form-control <?php echo is_invalid_class($_SESSION['errors'],'validemail') ?>">
                        <span class="info d-block">Entrez le code reçu par EMAIL et appuyez sur continue.</span>
					...
					<div>
                        ...
                        * Si le message n’apparaît pas dans votre Boîte de Réception, celui-ci peut se trouver dans le dossier Spam, Indésirable<br>
                       </span>
                    </div>
                </form>
            </div>
